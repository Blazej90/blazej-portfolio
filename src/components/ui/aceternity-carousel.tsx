...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
  ...
  const { src, title, description, githubUrl, liveDemoUrl } = slide;
    ...
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      ...
      >
        ...
        >
          ...
          <p className="text-sm text-gray-300 mt-2 max-w-[90%] mx-auto">
            {description}
          </p>
...
export function AceternityCarousel({ slides }: { slides: SlideData[] }) {
